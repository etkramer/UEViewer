...
struct Callback<Ret (ParamTypes...)>
{
    protected:
        ...
        template <typename T>
        friend struct Detail::WrapFunction;
    ...
    public:
        ...
        template <typename Dummy = void, typename = typename Detail::TEnableIf<
                      (sizeof...(ParamTypes) > 0), Dummy>::Type>
...
namespace Detail
{
    ...
    struct WrapFunction<Ret (Class::*)(ParamTypes...) const>
    {
        ...
        {
            return Callback<CallbackType>(reinterpret_cast<VoidCallerType*>(Caller<MethodPtr>()),
                                          const_cast<Class*>(obj));
        }
    };
    ...
    struct WrapLambda
    {
        ...
        template <typename FunctorType, typename = typename Detail::TEnableIf<__is_empty(FunctorType) && __is_class(
                      FunctorType)>::Type>
        FORCEINLINE static auto wrap(const FunctorType&)
            -> CallbackType<FunctorType>
        {
            typedef Wrapper<FunctorType> SuperType;
            return CallbackType<FunctorType>(reinterpret_cast<typename SuperType::VoidCallerType*>(SuperType::Caller()),
                                             nullptr);
        }
        ...
        template <typename FunctorType, typename = typename Detail::TEnableIf<!__is_empty(FunctorType) && __is_class(
                      FunctorType)>::Type, typename = void>
        static auto wrap(FunctorType&& func)
            -> CallbackType<FunctorType>
        {
            typedef Wrapper<FunctorType> SuperType;
            return CallbackType<FunctorType>(reinterpret_cast<typename SuperType::VoidCallerType*>(SuperType::Caller()),
                                             Detail::Forward<FunctorType>(func));
        }
