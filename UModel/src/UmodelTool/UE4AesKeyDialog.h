        ...
        void InitUI()
        {
            ...
            [
                ...
                [
                    ...
                    .SetWidth(EncodeWidth(1.0f))
                    [
                        NewControl(UILabel, "UE Viewer has found an encrypted UE4 pak file. In order to work correctly")
                        .SetAutoSize()
                        + NewControl(UILabel, "please specify an AES encryption key which is used for this game.").
                        SetAutoSize()
                        + NewControl(UILabel, "Multiple AES keys could be entered, each key on the new line").
                        SetAutoSize()
                        + NewControl(UISpacer)
