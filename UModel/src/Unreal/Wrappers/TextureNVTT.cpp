...
{
    uint8 dummy[128];
    NVTTStream* stream = new
        NVTTStream(dummy, sizeof(dummy), const_cast<unsigned char*>(Data), USize * VSize * 4, true);
    // deleted in DirectDrawSurface destructor
