...
class UTexture2D : public UTexture3
{
    ...
    public:
        ...
        bool LoadBulkTexture(const TArray<FTexture2DMipMap>& MipsArray, int MipIndex, const char* tfcSuffix,
                             bool verbose) const;
...
class UTextureCube3 : public UTexture3
{
    ...
    public:
        ...
        virtual void Serialize(FArchive& Ar)
        {
            Super::Serialize(Ar);
            #if TRANSFORMERS
            if (Ar.Game == GAME_Transformers && Ar.ArLicenseeVer >= 108) goto skip_rest_quiet;
