            ...
            case TPF_V8U8_2:
                {
                    ...
                    for (int i = 0; i < USize * VSize; i++)
                    {
                        ...
                        if (t >= 0)
                            ...
                            //!! TODO: check for correct function here - should be (t+1.0)*127.5, at least for 'offset==0'
                        else
                            d[2] = 255;
                        d[3] = 255;
                        d += 4;
                ...
                return dst;
            case TPF_A1:
                appNotify("TPF_A1 unsupported");
            //!! easy to do, but need samples - I've got some PF_A1 textures with no mipmaps inside
                return dst;
