    ...
    public:
        ...
        void PrintHeaders()
        {
            ...
            for (i = 0; i < Hdr.dir.Num(); i++)
            {
                ...
                appPrintf("[%d] %08X - (%s) %s / %d (%08X)\n", i, Dir.id, *Dir.ShortFilename, *Dir.Filename,
                          Dir.FileSize, Dir.FileSize);
            }
