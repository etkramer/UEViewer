...
enum EBoneTranslationRetargetingMode
{
    ...
    AnimationScaled,
    // translation from animation, scale it with TargetBoneTranslation.Size / SourceBoneTranslation.Size
...
struct FTrackToSkeletonMap
{
        ...
        BEGIN_PROP_TABLE
            ...
            PROP_DROP(SkeletonIndex)
            // this field was deprecated even before 4.0 release, however it appears in some old assets
        END_PROP_TABLE
...
struct FCompressedSegment
{
    ...
    friend FArchive& operator<<(FArchive& Ar, FCompressedSegment& S)
    {
        ...
        Ar << (byte&)S.TranslationCompressionFormat << (byte&)S.RotationCompressionFormat << (byte&)S.
