...
class CAnimSet
{
    public:
        ...
        // may be empty (for pre-UE4), position in array matches TrackBoneNames
        ...
        EBoneRetargetingMode GetBoneTranslationMode(int BoneIndex,
                                                    EAnimRetargetingMode RetargetingMode =
                                                        EAnimRetargetingMode::AnimSet) const
        {
            if (BoneIndex == 0)
            {
