...
class UnPackage : public FArchive
{
    ...
    public:
        ...
        int FindExportForImport(const char* ObjectName, const char* ClassName, UnPackage* ImporterPackage,
                                int ImporterIndex);
        ...
        void GetFullExportName(const FObjectExport& Exp, char* buf, int bufSize, bool IncludeObjectName = true,
                               bool IncludeCookedPackageName = true) const;
    ...
    private:
        ...
        void LoadExportTableIoStore(
            ...
            const TArray<struct FExportBundleHeader>& BundleHeaders,
            const TArray<struct FExportBundleEntry>& BundleEntries);
        void LoadImportTableIoStore(const byte* Data, int ImportCount,
                                    const TArray<const CGameFileInfo*>& ImportPackages,
                                    struct CImportTableErrorStats& ErrorStats);
        #endif // UNREAL4
