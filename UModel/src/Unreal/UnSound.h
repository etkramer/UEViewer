    ...
    public:
        ...
        void Serialize(FArchive& Ar)
        {
            guard(USound::Serialize)
                ...
                if ((Ar.Game == GAME_UT2 || Ar.Game == GAME_BattleTerr || Ar.Game == GAME_Loco) && Ar.ArLicenseeVer >=
                    2)
                    Ar << f2C;
                #endif
                Ar << RawData;
    ...
    public:
        ...
        void Serialize(FArchive& Ar)
        {
            guard(USoundWave::Serialize)
                ...
                if (Ar.ArVer >= VER_UE4_SOUND_COMPRESSION_TYPE_ADDED && FFrameworkObjectVersion::Get(Ar) <
                    FFrameworkObjectVersion::RemoveSoundWaveCompressionName)
                {
